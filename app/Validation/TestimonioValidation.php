...
class TestimonioValidation
{
    public static function testimonioGuardarValidation(array $data): array
    {
        $errors = [];
        $testimonioModel = new \App\Models\TestimonioModel();
        ...
        if (!empty($data['nombre'])) {
            $existeNombre = $testimonioModel->where('nombre', $data['nombre'])->first();
            if ($existeNombre) {
        ...
        if (!empty($data['urlAmigable'])) {
            $existeUrl = $testimonioModel->where('urlamigable', $data['urlAmigable'])->first();
            if ($existeUrl) {
    ...
    public static function testimonioActualizarValidation(array $data): array
    {
        $errors = [];
